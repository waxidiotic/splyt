...
module.exports = {
  ...
  rules: {
    'plugin/8-point-grid': {
      // Define 4 as base because we do allow 4, 12, 20, etc. in certain cases
      base: 4,
      allowlist: ['2px', '1px', '-1px'],
    ...
    'order/order': [
      ...
      // Theme or other global UI flag modifier
      {
        type: 'at-rule',
        name: 'include',
        hasBlock: true,
    ...
    // Fix SCSS compatibility with CSS modules
